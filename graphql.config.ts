...
const config: IGraphQLConfig = {
    ...
    extensions: {
        ...
        // https://the-build.dev/graphql/codegen
        codegen: {
            ...
            generates: {
                ...
                "src/graphql/schema.types.ts": {
                    ...
                    config: {
                      ...
                      // scalars is used to define how the scalars i.e. DataTime, JSON, etc. will be generated
                ...
                "src/graphql/types.ts": {
                    ...
                    config: {
                      ...
                      // instead, it will generate more generic types, and the actual types will be resolved ar runtime.
                      preResolveTypes: false,
                      // useTypeImports is used to import types using import type instead of import.
                      useTypeImports: true,
                    },
                    // presetConfig is used to define the configuration of the preset
                    presetConfig: {
