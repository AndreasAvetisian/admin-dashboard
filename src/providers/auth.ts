...
export const authProvider: AuthProvider = {
    login: async ({ email }) => {
      try {
          ...
          const { data } = await dataProvider.custom({
              ...
              meta: {
                  variables: { email },
                  // pass the email to see if the user exists an if so, return the accessToken
                  rawQuery: `
    ...
    logout: async () => {
        ...
        // simply remove the accessToken from localStorage
    ...
    getIdentity: async () => {
        ...
        try {
            ...
            // I am using me: any because the GraphQL API does not have a type for the me query yet
